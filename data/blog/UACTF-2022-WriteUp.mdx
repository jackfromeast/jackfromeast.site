---
title: 'UACTF 2022 Writeup'
date: '2022-08-05'
tags: ['Writeup']
draft: false
summary: '简介：  本文为UACTF 2022比赛的WriteUp。本次还是与NING0121、meishijia一起组队参赛，最终在447支参赛队伍中排名21位。打怪升级中，再接再厉～'
---
...
![img](/static/images/UACTF-2022-WriteUp/SYFwFZuYoVBUlNe4eJ8wdQ.png)

接着进行访问，阅读逻辑后发现需要实现三个 success 才能够显示出 flag，于是首先尝试直接修改 html 的标签（果然异想天开），接着就需要首先三个条件。

![1-1-3](/static/images/UACTF-2022-WriteUp/1-1-3.png)
...
![1-1-4](/static/images/UACTF-2022-WriteUp/1-1-4.png)
...
![1-2-1](/static/images/UACTF-2022-WriteUp/1-2-1.png)

使用 burpsuite 拦截并修改数据如下即可。

![1-2-2](/static/images/UACTF-2022-WriteUp/1-2-2.png)

页面打印出了 flag。

![img](/static/images/UACTF-2022-WriteUp/RhUs09PxOqfzokWQDGm_zg.png)
...
![image (20)](</static/images/UACTF-2022-WriteUp/image%20(20).png>)
...
![img](/static/images/UACTF-2022-WriteUp/LuaUPWbAGEdOkaVaQg2Ymg.png)
...
![img](/static/images/UACTF-2022-WriteUp/w6zMVJ9M6MTfqBH0RVoIig.png)
...
![img](/static/images/UACTF-2022-WriteUp/gxBQBJeZKthbMtE3oWIpRg.png)

![2-2-1](/static/images/UACTF-2022-WriteUp/2-2-1.png)
...
![2-3-2](/static/images/UACTF-2022-WriteUp/2-3-2.png)

### **2-4 Evil Eval [Aha!]**

​ ![img](/static/images/UACTF-2022-WriteUp/nPRd3TLyFMCDf-S1gkhaCg.jpeg)
...
![img](/static/images/UACTF-2022-WriteUp/dnuchhhOzEH1SUkK4IxdTw.png)
...
![](/static/images/UACTF-2022-WriteUp/sdGz0iLYlrDRW3HbY-DLsQ.png)

读取flag.txt文件中的字符串

![img](/static/images/UACTF-2022-WriteUp/WI_JGGuyjQESWemayXrc9w.png)

![img](/static/images/UACTF-2022-WriteUp/0L_WvOZqD1D1jUi7MfoJaw.png)

reseed函数是读取字符串的四个字符，并以他们在内存当中的数据作为随机数产生的种子。\_\_int64 s就是字符串的首地址，DWORD是双字，也就是四个字节，即四个字符。该函数，就相当于以首地址为基址，以4\*i为偏移，大小为四个字节的字符串作为随机数产生的种子。

![img](/static/images/UACTF-2022-WriteUp/q2ZI1sUX3Ru4eR-ZUn0rWw.png)
...
![](/static/images/UACTF-2022-WriteUp/4-1-1.png)
...
![img](/static/images/UACTF-2022-WriteUp/5NmtIwIgvqppomDYyFEWRw.png)
...
![6-1-1](/static/images/UACTF-2022-WriteUp/6-1-1.png)
...
![6-2-1](/static/images/UACTF-2022-WriteUp/6-2-1.png)
...
![img](/static/images/UACTF-2022-WriteUp/NNLFcy8P3GDyx1lMmoUiYg.png)
...
![forenics-3](/static/images/UACTF-2022-WriteUp/forenics-3.png)
