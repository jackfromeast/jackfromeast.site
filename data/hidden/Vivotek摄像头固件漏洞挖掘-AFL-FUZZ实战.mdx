...
```
<div style="width:100%;margin:auto">{% asset_img 0-1.png %}</div>
...
```
<div style="width:100%;margin:auto">{% asset_img 0-3.png %}</div>

如果遇到如下报错可以尝试通过[这篇博客](https://blog.csdn.net/liyihao17/article/details/109981662)解决。
<div style="width:100%;margin:auto">{% asset_img 0-2.png %}</div>
...
## 简介
查看该二进制文件的信息如下:
<div style="width:100%;margin:auto">{% asset_img 1-1.png %}</div>
...
<div style="width:100%;margin:auto">{% asset_img 1-2.png %}</div>
...
<div style="width:100%;margin:auto">{% asset_img 1-9.png %}</div>
...
<div style="width:100%;margin:auto">{% asset_img 1-10.png %}</div>
...
```
<div style="width:100%;margin:auto">{% asset_img 1-3.png %}</div>
...
ldd ./qemu-arm
```
<div style="width:100%;margin:auto">{% asset_img 1-4.png %}</div>
...
```
<div style="width:100%;margin:auto">{% asset_img 1-5.png %}</div>


再次运行chroot命令，发现可以成功执行httpd二进制文件了！
<div style="width:100%;margin:auto">{% asset_img 1-6.png %}</div>
...
<div style="width:100%;margin:auto">{% asset_img 2-1.png %}</div>
...
```
<div style="width:100%;margin:auto">{% asset_img 2-2.png %}</div>
...
<div style="width:100%;margin:auto">{% asset_img 2-3.png %}</div>
...
<div style="width:100%;margin:auto">{% asset_img 2-4.png %}</div>


如果没有其他错误，即可顺利出现以下的界面。`Have a nice day!`
<div style="width:100%;margin:auto">{% asset_img 2-5.png %}</div>